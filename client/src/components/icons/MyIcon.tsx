...
const MyIcon = ({ iconName, setIsSidebarClosed }: IconType): JSX.Element => {
   const myIcon: Record<IconName, string> = {
      dashboard: `<svg width="20" height="18" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M9.918 10.0005H7.082C6.66587 9.99708 6.26541 10.1591 5.96873 10.4509C5.67204 10.7427 5.50343 11.1404 5.5 11.5565V17.4455C5.5077 18.3117 6.21584 19.0078 7.082 19.0005H9.918C10.3341 19.004 10.7346 18.842 11.0313 18.5502C11.328 18.2584 11.4966 17.8607 11.5 17.4445V11.5565C11.4966 11.1404 11.328 10.7427 11.0313 10.4509C10.7346 10.1591 10.3341 9.99708 9.918 10.0005Z" stroke="#000000" stroke-width="0.85" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M9.918 4.0006H7.082C6.23326 3.97706 5.52559 4.64492 5.5 5.4936V6.5076C5.52559 7.35629 6.23326 8.02415 7.082 8.0006H9.918C10.7667 8.02415 11.4744 7.35629 11.5 6.5076V5.4936C11.4744 4.64492 10.7667 3.97706 9.918 4.0006Z" stroke="#000000" stroke-width="0.85" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.082 13.0007H17.917C18.3333 13.0044 18.734 12.8425 19.0309 12.5507C19.3278 12.2588 19.4966 11.861 19.5 11.4447V5.55666C19.4966 5.14054 19.328 4.74282 19.0313 4.45101C18.7346 4.1592 18.3341 3.9972 17.918 4.00066H15.082C14.6659 3.9972 14.2654 4.1592 13.9687 4.45101C13.672 4.74282 13.5034 5.14054 13.5 5.55666V11.4447C13.5034 11.8608 13.672 12.2585 13.9687 12.5503C14.2654 12.8421 14.6659 13.0041 15.082 13.0007Z" stroke="#000000" stroke-width="0.85" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.082 19.0006H17.917C18.7661 19.0247 19.4744 18.3567 19.5 17.5076V16.4936C19.4744 15.6449 18.7667 14.9771 17.918 15.0006H15.082C14.2333 14.9771 13.5256 15.6449 13.5 16.4936V17.5066C13.525 18.3557 14.2329 19.0241 15.082 19.0006Z" stroke="#000000" stroke-width="0.85" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`,
      complaints: `<svg width="20" height="18" viewBox="-2.4 -2.4 28.80 28.80" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000" transform="rotate(0)matrix(-1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="1.008"></g><g id="SVGRepo_iconCarrier"><defs><style>.cls-1{fill:none;stroke:#020202;stroke-miterlimit:10;stroke-width:1.2;}</style></defs><line class="cls-1" x1="12" y1="5.3" x2="12" y2="11.98"></line><path class="cls-1" d="M1.5,5.3v9.54a3.82,3.82,0,0,0,3.82,3.82H7.23v2.86L13,18.66h5.73a3.82,3.82,0,0,0,3.82-3.82V5.3a3.82,3.82,0,0,0-3.82-3.82H5.32A3.82,3.82,0,0,0,1.5,5.3Z"></path><line class="cls-1" x1="11.05" y1="13.89" x2="12.95" y2="13.89"></line></g></svg>`,
      burger: `<svg width="20" height="18" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.898019">
...
`,
      downArrow: `<svg width="20" height="18" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.19995 0.100403C14.2257 0.100403 18.2996 4.17422 18.2996 9.20001C18.2996 14.2258 14.2257 18.2996 9.19995 18.2996C4.17416 18.2996 0.100342 14.2258 0.100342 9.20001C0.100342 4.17422 4.17416 0.100403 9.19995 0.100403Z" stroke="#5C5C5C" stroke-width="0.2"/>
<path d="M9.19995 9.99291L6.93157 7.34646C6.7642 7.1512 6.49284 7.1512 6.32548 7.34646C6.15811 7.54172 6.15811 7.8583 6.32548 8.05357L8.89691 11.0536C9.06427 11.2488 9.33563 11.2488 9.503 11.0536L12.0744 8.05357C12.2418 7.8583 12.2418 7.54172 12.0744 7.34646C11.9071 7.1512 11.6357 7.1512 11.4683 7.34646L9.19995 9.99291Z" fill="#565656"/>
<mask id="mask0_330_4477" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="6" y="7" width="7" height="5">
<path d="M9.19995 9.99291L6.93157 7.34646C6.7642 7.1512 6.49284 7.1512 6.32548 7.34646C6.15811 7.54172 6.15811 7.8583 6.32548 8.05357L8.89691 11.0536C9.06427 11.2488 9.33563 11.2488 9.503 11.0536L12.0744 8.05357C12.2418 7.8583 12.2418 7.54172 12.0744 7.34646C11.9071 7.1512 11.6357 7.1512 11.4683 7.34646L9.19995 9.99291Z" fill="white"/>
</mask>
<g mask="url(#mask0_330_4477)">
</g>
</svg>
`,
...
`,
   ...
   return setIsSidebarClosed ? (
      <i
         onClick={() => setIsSidebarClosed((prev) => !prev)}
         id="icon"
         dangerouslySetInnerHTML={{ __html: myIcon[iconName] }}
      />
   ) : (
      <i id="icon" dangerouslySetInnerHTML={{ __html: myIcon[iconName] }} />
   );
};
